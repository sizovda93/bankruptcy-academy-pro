...
export default function CoursePromotionNoAds() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <section className="bg-gradient-to-b from-secondary/40 to-background py-16 sm:py-20">
          <div className="container max-w-6xl">
            <h1 className="font-heading text-4xl font-bold leading-tight text-foreground sm:text-5xl">
              Продвижение без вложений в рекламу
            </h1>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {keyBenefits.map((benefit) => (
                <div key={benefit} className="rounded-xl border bg-card p-4 text-sm font-medium text-foreground">
                  {benefit}
                </div>
              ))}
            </div>
            ...
            <div className="mt-8">
              <Button className="h-12 px-8 text-base" onClick={() => setIsLeadModalOpen(true)}>
                Получить программу и условия участия
              </Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Боль рынка: почему это важно сейчас</h2>
            <p className="text-muted-foreground">
              Юридический рынок БФЛ меняется быстро: конкуренция растёт каждый день, реклама дорожает, клиентов
              приходится дожимать дольше, практика и требования кредиторов становятся жёстче.
            </p>
            <p className="text-muted-foreground">
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-6">
            <h2 className="font-heading text-3xl font-bold">Результаты</h2>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-6">
            <h2 className="font-heading text-3xl font-bold">Программа</h2>
            {modules.map((module) => (
              <article key={module.title} className="rounded-xl border bg-card p-5">
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Формат обучения</h2>
            <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              <li>1–2 занятия в неделю (Zoom)</li>
              <li>Домашние задания + практические сессии</li>
              <li>Коуч-сессия по индивидуальной траектории роста</li>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Преимущества</h2>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Ожидания после внедрения</h2>
            <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
        ...
        <section className="py-10">
          <div className="container max-w-6xl rounded-xl border bg-card p-6">
            <h2 className="font-heading text-3xl font-bold">Ведущий</h2>
      ...
      <Dialog open={isLeadModalOpen} onOpenChange={setIsLeadModalOpen}>
        <DialogContent className="w-[96vw] max-w-[760px] p-4 sm:p-6">
          <DialogTitle className="sr-only">Заявка на участие</DialogTitle>
