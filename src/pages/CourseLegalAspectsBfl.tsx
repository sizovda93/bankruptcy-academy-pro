      ...
      <main className="animate-page-enter">
        <section className="bg-gradient-to-b from-secondary/40 to-background py-16 sm:py-20">
          <div className="container max-w-6xl">
            ...
            <p className="mt-2 text-lg font-medium text-primary">Курс для старта юридической практики БФЛ</p>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {highlights.map((item) => (
                <div key={item} className="rounded-xl border bg-card p-4 text-sm font-medium text-foreground">
                  {item}
                </div>
              ))}
            </div>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Кому подходит</h2>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Результаты на выходе</h2>
            <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              {outcomes.map((item) => (
                <li key={item}>{item}</li>
              ))}
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-6">
            <h2 className="font-heading text-3xl font-bold">Структура курса по занятиям</h2>
            {lessons.map((lesson) => (
              <article key={lesson.title} className="rounded-xl border bg-card p-5">
                <h3 className="font-heading text-xl font-semibold">{lesson.title}</h3>
        ...
        <section className="py-10">
          <div className="container max-w-6xl space-y-4">
            <h2 className="font-heading text-3xl font-bold">Формат обучения и правила</h2>
            <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
              <li>Участники задают вопросы и выполняют задания</li>
              <li>После каждого семинара — тестирование</li>
              <li>Сертификат при результате выше 80% (по правилам курса)</li>
            </ul>
          </div>
        </section>
