  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="animate-page-enter">
          ...
          <div className="container max-w-6xl">
            <div className="grid gap-6 rounded-3xl bg-gradient-to-br from-primary via-primary-glow to-emerald-500 p-6 sm:p-8 lg:grid-cols-2 lg:p-10">
              <div className="text-white">
                ...
                <p className="mt-6 text-lg leading-relaxed text-white/90 sm:text-xl">«Юридические аспекты процедуры банкротства граждан 2.0» — практико-ориентированный курс по банкротству физлиц от старта до торгов и распределения конкурсной массы.</p>
                <div className="mt-8 grid gap-3">{highlights.map((item) => (<div key={item} className="rounded-xl border border-white/20 bg-white/10 p-3 text-sm font-medium text-white">{item}</div>))}</div>
              </div>
              <div id="course-form"><LeadFormContent compact /></div>
            </div>
          </div>
        </section>

        <section className="py-14"><div className="container max-w-6xl space-y-5"><h2 className="font-heading text-3xl font-bold">Что это за курс</h2><p className="text-muted-foreground">Упор курса: правильный вход в процедуру, снижение рисков на сложных делах, стандарты подготовки документов и взаимодействия с АУ, тестирование и сертификация по итогам.</p><p className="text-muted-foreground">Автор/ведущий: Василий Алексеевич Артин — эксперт по банкротству физлиц, руководитель команды АУ, директор по развитию группы «Федеральная экспертная служба».</p></div></section>
        ...
        <section id="apply" className="py-14"><div className="container max-w-6xl rounded-2xl border bg-card p-6 sm:p-8"><h2 className="font-heading text-3xl font-bold">Готовы усилить юридическую практику БФЛ?</h2><p className="mt-3 text-muted-foreground">Оставьте заявку — пришлём программу, формат участия и условия потока.</p><div className="mt-6"><a href="#course-form"><Button className="h-12 px-8 text-base">Открыть форму заявки</Button></a></div></div></section>
      </main>
